...
import leetcode.solution.SolutionRemoveElement;
import leetcode.utils.StringToIntArrayUtil;
...
public class TestRemoveElement {
  ...
  private void testSolution(int[] nums, int[] expectedNums, int valueToRemove) {
    ...
    assertEquals(expectedNums.length, expectedLength,
        "Number of value different of [" + valueToRemove + "] is : " + expectedLength);
