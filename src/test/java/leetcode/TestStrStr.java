...
import main.java.leetcode.solution.SolutionStrStr;
...
public class TestStrStr {
    ...
    public void compare() {
        ...
        System.out.println(STR."Execution time: \{myStrStrDuration} ms, with value : \{myStrStrValue}");

        startTime = System.nanoTime();
        int strStrValue = solution.myStrStr(haystack, needle);
        endTime = System.nanoTime();
        long strStrDuration = (endTime - startTime) / 1_000_000;
        System.out.println(STR."Execution time: \{strStrDuration} ms, with value : \{strStrValue}");
    }
}
